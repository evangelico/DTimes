...
public class SubscriptionBusinessImpl implements SubscriptionBusiness {
	...
	public SubscriptionDTO update(SubscriptionDTO subscriptionToUpdate) throws Exception {
		...
		subscriptionTmp.setPlaceOfBirth(subscriptionToUpdate.getPlaceOfBirth());
	...
	@Override
	@Transactional
	public long countTotalSubscription() throws Exception {
		return subscriptionDAO.count();
	}

	@Override
	@Transactional
	public long countTotalSubscriptionByPlainAndNominative(String nominative,long plainId) throws Exception {
		return subscriptionDAO.countTotalSubscriptionByPlainAndNominative(nominative,plainId);
	}

	@Override
	@Transactional
	public long countTotalSubscriptionByNominative(String nominative) throws Exception {
		return subscriptionDAO.countTotalSubscriptionByNominative(nominative);
	}

	@Override
	@Transactional
	public long countTotalSubscriptionByPlain(long plainId) throws Exception {
		return subscriptionDAO.countTotalSubscriptionByPlain(plainId);
	}
